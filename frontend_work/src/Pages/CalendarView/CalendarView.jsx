...
import { Button, Col, Container, FormGroup, FormLabel, FormSelect, InputGroup, Row } from "react-bootstrap";
...
const CalendarView = () => {
    ...
    return (
        <div className="App">
                    ...
                    <Col md={12}>
                        <FullCalendar
                            ...
                            headerToolbar={{
                                ...
                                center: "title",
                                right: "monthGridYear,dayGridMonth,timeGridWeek,timeGridDay"
                            }}
                            buttonText={{
                                today: "current",
                                year:"Year",
            ...
            >
                <FormGroup>
                    <FormLabel for="exampleEmail">Title</FormLabel>
                    <InputGroup
                        type="text"
                        name="title"
                ...
                <FormGroup>
                    <FormLabel for="exampleEmail">From - End</FormLabel>
                    <DateRangePicker
                        initialSettings={{
                            locale: {
                                format: "M/DD hh:mm A"
